...
def crispr_test(tab,ctrlg,testg, destfile,sgrna2genelist,args):
  ...
  sgrnalfc=[0.0]*n
  # output to file
  print('\t'.join(['sgrna','Gene','control_count','treatment_count','control_mean','treat_mean', 'LFC', 'control_var','adj_var','score','p.low','p.high','p.twosided','FDR','high_in_treatment']),file=destf)
  for i in sort_id:
